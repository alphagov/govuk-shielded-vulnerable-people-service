...
def get_redirect_for_returning_user_based_on_tier():
    ...
    if original_uprn:
        ...
        latest_shielding_advice = location_eligibility.get_uprn_shielding(original_uprn, current_app)
    else:
        latest_location_tier = location_eligibility.get_postcode_tier(original_postcode)
        latest_shielding_advice = location_eligibility.get_postcode_shielding(original_postcode, current_app)
