...
def test_persist_answers_should_map_parameters_correctly():
    ...
    test_answers = _create_dummy_answers()
    ...
    with patch("vulnerable_people_form.integrations.persistence.execute_sql",
        ...
        submission_reference = persist_answers(
            test_answers["nhs_number"],
            test_answers["first_name"],
            test_answers["middle_name"],
            test_answers["last_name"],
            test_answers["date_of_birth"],
            test_answers["address_line1"],
            test_answers["address_line2"],
            test_answers["address_town_city"],
            test_answers["address_postcode"],
            test_answers["address_uprn"],
            test_answers["contact_number_calls"],
            test_answers["contact_number_texts"],
            test_answers["contact_email"],
            test_answers["uid_nhs_login"],
            test_answers["are_you_applying_on_behalf_of_someone_else"],
            test_answers["have_you_received_an_nhs_letter"],
            test_answers["do_you_want_supermarket_deliveries"],
            test_answers["do_you_need_help_meeting_your_basic_care_needs"],
        ...
        mock_execute_sql.assert_called_once_with(
            ...
            parameters=(
                {"name": "nhs_number", "value": {"stringValue": test_answers["nhs_number"]}},
                {
                    ...
                    "value": {"doubleValue": test_answers["have_you_received_an_nhs_letter"]}
                },
                {"name": "first_name", "value": {"stringValue": test_answers["first_name"]}},
                {"name": "middle_name", "value": {"isNull": True}},
                {"name": "last_name", "value": {"stringValue": test_answers["last_name"]}},
                {"name": "address_line1", "value": {"stringValue": test_answers["address_line1"]}},
                {"name": "address_postcode", "value": {"stringValue": test_answers["address_postcode"]}},
                {"name": "address_town_city", "value": {"stringValue": test_answers["address_town_city"]}},
                {"name": "address_uprn", "value": {"isNull": True}},
                {"name": "contact_number_calls", "value": {"stringValue": test_answers["contact_number_calls"]}},
                {"name": "contact_number_texts", "value": {"stringValue": test_answers["contact_number_texts"]}},
                {"name": "contact_email", "value": {"stringValue": test_answers["contact_email"]}},
                {
                    "name": "do_you_have_one_of_the_listed_medical_conditions",
                    "value": {"doubleValue": test_answers["do_you_have_one_of_the_listed_medical_conditions"]}
                },
                {
                    "name": "are_you_applying_on_behalf_of_someone_else",
                    "value": {"doubleValue": test_answers["are_you_applying_on_behalf_of_someone_else"]}
                },
                {
                    "name": "do_you_want_supermarket_deliveries",
                    "value": {"doubleValue": test_answers["do_you_want_supermarket_deliveries"]}
                },
                {
                    "name": "date_of_birth",
                    "typeHint": "DATE",
                ...
                },
                {
                    ...
                    "value": {"doubleValue": test_answers["do_you_have_someone_to_go_shopping_for_you"]}
                },
                ...
                {"name": "address_line2", "value": {"isNull": True}},
                {
                    ...
                    "value": {"doubleValue": test_answers["do_you_need_help_meeting_your_basic_care_needs"]}
                },
                {
                    "name": "do_you_live_in_england",
                    "value": {"doubleValue": test_answers["do_you_live_in_england"]}
                },
                {
