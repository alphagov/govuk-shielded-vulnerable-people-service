...
GOVUK_NOTIFY_SPL_MATCH_EMAIL_TEMPLATE_ID = os.environ.get("GOVUK_NOTIFY_SPL_MATCH_EMAIL_TEMPLATE_ID")
GOVUK_NOTIFY_SPL_MATCH_SMS_TEMPLATE_ID = os.environ.get("GOVUK_NOTIFY_SPL_MATCH_SMS_TEMPLATE_ID")
GOVUK_NOTIFY_SPL_MATCH_LETTER_TEMPLATE_ID = os.environ.get("GOVUK_NOTIFY_SPL_MATCH_LETTER_TEMPLATE_ID")
GOVUK_NOTIFY_NO_SPL_MATCH_EMAIL_TEMPLATE_ID = os.environ.get("GOVUK_NOTIFY_NO_SPL_MATCH_EMAIL_TEMPLATE_ID")
GOVUK_NOTIFY_NO_SPL_MATCH_SMS_TEMPLATE_ID = os.environ.get("GOVUK_NOTIFY_NO_SPL_MATCH_SMS_TEMPLATE_ID")
GOVUK_NOTIFY_NO_SPL_MATCH_LETTER_TEMPLATE_ID = os.environ.get("GOVUK_NOTIFY_NO_SPL_MATCH_LETTER_TEMPLATE_ID")
